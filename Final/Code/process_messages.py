...
def process_data():
    try:
        ...
        matches_file = os.path.join(current_dir, 'Data', 'Lydia', 'hinge', 'hinge', 'matches.json')
        user_file = os.path.join(current_dir, 'Data', 'Lydia', 'hinge', 'hinge', 'user.json')
        prompts_file = os.path.join(current_dir, 'Data', 'Lydia', 'hinge', 'hinge', 'prompts.json')
        ...
        output_file = os.path.join(output_dir, f'{user_name.lower()}_clean_data.json')
